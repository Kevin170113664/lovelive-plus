...
class SmCalculatorController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
	...
	func addObserverToListenKeyboardEvent() {
		NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SmCalculatorController.keyboardWillShow(_:)), name: UIKeyboardWillShowNotification, object: nil)
		NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(SmCalculatorController.keyboardWillHide(_:)), name: UIKeyboardWillHideNotification, object: nil)
	...
	func initEventTimePanel() {
		...
		eventEndDay.addTarget(self, action: #selector(SmCalculatorController.eventEndDayDidChange(_:)), forControlEvents: UIControlEvents.EditingChanged)
		eventEndHour.delegate = self
		eventEndHour.addTarget(self, action: #selector(SmCalculatorController.eventEndHourDidChange(_:)), forControlEvents: UIControlEvents.EditingChanged)
	}
